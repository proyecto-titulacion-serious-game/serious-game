...
* **`ComponentSendingTray`**: Bandeja de envío sobre la mesa del Técnico. PC: el Técnico hace click...
* **`DeskComponent`**: Componente físico sobre la mesa del Técnico. PC: hover brillo + click...
...
> **Última actualización:** 21/04/2026 16:16:22 (Quito, EC)
